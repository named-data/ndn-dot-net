...
namespace TestNdnDotNet {
  class TestEncodeDecodeBenchmark {
    ...
    static byte[] DEFAULT_EC_PUBLIC_KEY_DER = new byte[] {
    ...
    static byte[] DEFAULT_EC_PRIVATE_KEY_DER = new byte[] {
     ...
     */
    private static void
    benchmarkEncodeDecodeData(bool useComplex, bool useCrypto, KeyType keyType)
    {
      String format = "TLV";
