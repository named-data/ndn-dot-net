...
namespace net.named_data.jndn.tests.unit_tests {
	...
	public class TestRsaAlgorithm {
		...
		private const String PRIVATE_KEY = "MIICdwIBADANBgkqhkiG9w0BAQEFAASCAmEwggJdAgEAAoGBAMLY2w1PmsuZNvZ4"
		...
		private const String PUBLIC_KEY = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDC2NsNT5rLmTb2eKybNaREi68R"
		...
		private static readonly ByteBuffer PLAINTEXT = toBuffer(new int[] { 0x52,
				0x53, 0x41, 0x2d, 0x45, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x2d,
				0x54, 0x65, 0x73, 0x74 });
	
		private static readonly ByteBuffer CIPHERTEXT_OAEP = toBuffer(new int[] {
		...
		private static readonly ByteBuffer CIPHERTEXT_PKCS = toBuffer(new int[] {
