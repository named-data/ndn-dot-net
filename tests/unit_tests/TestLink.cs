...
namespace net.named_data.jndn.tests.unit_tests {
	...
	public class TestLink {
		...
		private static readonly ByteBuffer LinkTest = toBuffer(new int[] {
				0x06,
				0xda, // Data
				0x07,
				0x14, // Name
		...
		private static readonly ByteBuffer IncorrectContentTypeLink = toBuffer(new int[] {
				0x06,
				0xda, // Data
				0x07,
				0x14, // Name
		...
		private static readonly ByteBuffer MissingPreferenceLink = toBuffer(new int[] {
				0x06,
				0xd7, // Data
				0x07,
				0x14, // Name
		...
		private static readonly ByteBuffer MissingNameLink = toBuffer(new int[] {
				0x06,
				0xd1, // Data
				0x07,
				0x14, // Name
		...
		private static readonly ByteBuffer InterestWithLink = toBuffer(new int[] {
				0x05,
				0xfb, // Interest
				0x07,
				0x14, // Name
				...
				0x1e, 0xdc, 0x78, 0xb3, 0xa7, 0xaa, 0x0d, 0x14, 0x58, 0x30, 0xe5,
				0x37, 0x6a, 0x6d, 0xdb, 0x56, 0xac, 0xa3, 0xfc, 0x90, 0x7a, 0xb8,
				0x66, 0x9c, 0x0e, 0xf6, 0xb7, 0x64, 0xd1, 0x20, 0x01, // SelectedDelegation
				0x00 });
	
		private static readonly ByteBuffer LINK = toBuffer(new int[] {
				0x06,
				0xda, // Data
				0x07,
				0x14, // Name
		...
		private static readonly ByteBuffer InterestWithLinkMissingContentType = toBuffer(new int[] {
				0x05,
				0xf8, // Interest
				0x07,
				0x14, // Name
		...
		private static readonly ByteBuffer InterestWithLinkNoMetaInfo = toBuffer(new int[] {
				0x05,
				0xf2, // Interest
				0x07,
				0x14, // Name
		...
		private static readonly ByteBuffer InterestWithLinkWrongContentType = toBuffer(new int[] {
				0x05,
				0xfb, // Interest
				0x07,
				0x14, // Name
		...
		private static readonly ByteBuffer InterestWithSelectedDelegationButNoLink = toBuffer(new int[] {
				0x05, 0x21, // Interest
				0x07, 0x14, // Name
				0x08, 0x5, // NameComponent
				0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x08, 0x3, // NameComponent
				0x6e, 0x64, 0x6e, 0x08, 0x6, // NameComponent
				0x70, 0x72, 0x65, 0x66, 0x69, 0x78, 0x09, 0x00, // Selectors
				0x0a, 0x4, // Nonce
				0x1, 0x0, 0x0, 0x00, 0x20, 0x01, // SelectedDelegation
				0x00 });
	
		private static readonly ByteBuffer InterestWithLinkNotNonIntegerSelectedDelegation = toBuffer(new int[] {
				0x05,
				0xfb, // Interest
				0x07,
				0x14, // Name
				...
				0x1e, 0xdc, 0x78, 0xb3, 0xa7, 0xaa, 0x0d, 0x14, 0x58, 0x30, 0xe5,
				0x37, 0x6a, 0x6d, 0xdb, 0x56, 0xac, 0xa3, 0xfc, 0x90, 0x7a, 0xb8,
				0x66, 0x9c, 0x0e, 0xf6, 0xb7, 0x20, 0x03, // SelectedDelegation
				0xAA, 0xAA, 0xAA });
	
		private static readonly ByteBuffer InterestWithLinkNonDecreasingOrder = toBuffer(new int[] {
				0x05,
				0xfb, // Interest
				0x07,
				0x14, // Name
		...
		public void testInsertDelegation() {
			Link link = new Link();
			...
			for (int i = 0; i < delegations.size(); ++i) {
				...
				if (i == 2) {
					Assert.AssertEquals(30, delegations.get(i).getPreference());
					Assert.AssertEquals(new Name("/test4"), delegations.get(i).getName());
				}
				if (i == 3) {
		...
		public void testMissingNameEncoding() {
			Link link = new Link();
			try {
		...
		public void testInterestLinkObjectMissingContentType() {
			Interest interest = new Interest();
	
			try {
				interest.wireDecode(new Blob(InterestWithLinkMissingContentType,
						false));
			} catch (Exception ex) {
				Assert.Fail("Decoding InterestWithLinkMissingContentType: "
						+ ex.Message);
			}
