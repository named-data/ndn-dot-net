...
namespace net.named_data.jndn.tests.unit_tests {
	...
	public class TestTpmPrivateKey {
		public TestTpmPrivateKey() {
			this.keyTestData = new TestTpmPrivateKey.KeyTestData [1];
		}
	
		internal class KeyTestData {
		...
		internal class RsaKeyTestData : TestTpmPrivateKey.KeyTestData  {
			public RsaKeyTestData() {
				keyParams = new RsaKeyParams();
	
				privateKeyPkcs1 = "MIIEpAIBAAKCAQEAw0WM1/WhAxyLtEqsiAJgWDZWuzkYpeYVdeeZcqRZzzfRgBQT\n"
		...
		internal class EcKeyTestData : TestTpmPrivateKey.KeyTestData  {
			public EcKeyTestData() {
				...
				publicKeyEncoding = "MIIBSzCCAQMGByqGSM49AgEwgfcCAQEwLAYHKoZIzj0BAQIhAP////8AAAABAAAA\n"
		...
		internal TestTpmPrivateKey.RsaKeyTestData  rsaKeyTestData;
		internal TestTpmPrivateKey.EcKeyTestData  ecKeyTestData;
	
		// debug KeyTestData[] keyTestData = new KeyTestData[2];
		internal TestTpmPrivateKey.KeyTestData [] keyTestData;
	
		public void setUp() {
			rsaKeyTestData = new TestTpmPrivateKey.RsaKeyTestData ();
			ecKeyTestData = new TestTpmPrivateKey.EcKeyTestData ();
