...
namespace net.named_data.jndn.tests.integration_tests {
	...
	public class TestPolicyManagerV2 {
		...
		private static readonly ByteBuffer TEST_RSA_PUBLIC_KEY_DER = toBuffer(new int[] {
		...
		private static readonly ByteBuffer TEST_RSA_PRIVATE_KEY_PKCS8 = toBuffer(new int[] {
		...
		private static String CERT_DUMP = "Bv0BnwcxCAR0ZW1wCANLRVkIEWtzay0xNDE0MTk1Nzc5NjY1CAdJRC1DRVJUCAgA"
		...
		internal PibMemory pibImpl_;
		internal TpmBackEndMemory tpmBackEnd_;
