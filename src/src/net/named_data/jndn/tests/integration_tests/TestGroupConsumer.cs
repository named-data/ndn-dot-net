...
namespace src.net.named_data.jndn.tests.integration_tests {
	...
	public class TestGroupConsumer : Consumer.Friend {
		...
		private static final ByteBuffer AES_KEY = toBuffer(new int[] { 0xdd, 0x60,
				0x77, 0xec, 0xa9, 0x6b, 0x23, 0x1b, 0x40, 0x6b, 0x5a, 0xf8, 0x7d,
				0x3d, 0x55, 0x32 });
	
		private static final ByteBuffer INITIAL_VECTOR = toBuffer(new int[] { 0x73,
				0x6f, 0x6d, 0x65, 0x72, 0x61, 0x6e, 0x64, 0x6f, 0x6d, 0x76, 0x65,
				0x63, 0x74, 0x6f, 0x72 });
