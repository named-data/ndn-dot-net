...
{
  /// <summary>
  /// An AsyncUdpTransport extends Transport to connect using a .NET 
  /// System.Net.Sockets.Socket over UDP using asynchronous communication.
  /// To use this, you do not need to call processEvents.
  /// </summary>
  public class AsyncUdpTransport : AsyncSocketTransport
  {
    /// <summary>
    /// Create an AsyncUdpTransport.
    /// </summary>
    public AsyncUdpTransport() : base(SocketType.Dgram, ProtocolType.Udp)
    {
    }

    /// <summary>
    /// An AsyncUdpTransport.ConnectionInfo extends Transport.ConnectionInfo to 
    /// hold the host and port info for the UDP connection.
    /// </summary>
