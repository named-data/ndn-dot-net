...
#else
      throw new NotImplementedException("generateKeyPair is not implemented");
#endif
		}
		...
		public override Blob sign(ByteBuffer data, Name keyName,
			...
			if (privateKey.getKeyType() == net.named_data.jndn.security.KeyType.RSA) {
				try {
					signature = System.Signature.getInstance("SHA256withRSA");
				} catch (Exception e) {
				...
				try {
					signature = System.Signature.getInstance("SHA256withECDSA");
				} catch (Exception e_0) {
					// Don't expect this to happen.
					throw new SecurityException(
...
#else
      throw new NotImplementedException("sign is not implemented");
#endif
		}
