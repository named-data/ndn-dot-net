...
namespace net.named_data.jndn.tests.integration_tests {
	...
	public class IntegrationTestsCommon {
		...
		/// <summary>
		/// Get the policy_config directory based on the current top-level jndn
		/// directory.
		/// </summary>
		///
		/// <returns></returns>
		public static FileInfo getPolicyConfigDirectory() {
			...
			for (int i = 0; i < path.Length; ++i) {
				result = new FileInfo(System.IO.Path.Combine(result.FullName,path[i]));
			}
	
			return result;
#else
      return new FileInfo("/Users/jefft0/work/jndn/tests/src/net/named_data/jndn/tests/integration_tests/policy_config");
#endif
		}
